...
public:
    struct Fields {
        ...
        gd::unordered_map<int,float> m_volumeForMusicChannelsBackup;
        gd::unordered_map<int,float> m_volumeModForMusicChannelsBackup;
        gd::unordered_map<int,float> m_pitchForMusicChannelsBackup;
    };
